            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    widget.product.categoryName.tr,
        ...
        Expanded(
          child: ElevatedButton(
            onPressed: () async {
              ...
              if (activeSugar == SugarMode.none) {
                sugarKey = "no_sugar";
                finalSweetness = "none"; // Reset sweetness for this mode
              } else if (activeSugar == SugarMode.sweetness) {
                sugarKey =
                    currentSweetness; // Save the key (e.g., 'less_sweet')
                finalSweetness = currentSweetness;
              } else {
                // Slider mode
                sugarKey = "${sugarVal.toInt()}%";
                finalSweetness = "standard"; // Default for percentage mode
              }
          ...
          child: ValueListenableBuilder<int>(
            ...
            builder: (_, __, ___) {
              ...
              return ElevatedButton(
                ...
                child: Text(
                  isEmpty ? "cart_is_empty".tr : "check_out".tr,
                  style: const TextStyle(
                    color: Colors.white,
                    fontSize: 16,
