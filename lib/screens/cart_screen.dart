...
class _CartScreenState extends State<CartScreen> {
  ...
  double get deliveryCharge => items.isEmpty ? 0 : 5;
  ...
  void initState() {
    super.initState();
    // loadCartFromApi();
    isLoading = false; // remove this when you use real API
  }
        ...
        child: isLoading
            ...
            : ListView(
                ...
                children: [
                  ...
                  _SummaryRow(label: "Delivery Charge", value: "\$${deliveryCharge.toStringAsFixed(2)}"),
